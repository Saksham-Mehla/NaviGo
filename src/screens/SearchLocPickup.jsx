		...
		<View style={styles.searchcontainer}>
			<View style={styles.searchbar}>
				<GooglePlacesAutocomplete
					...
					currenLocationLabel='Current Location'
					...
					onPress={
						(data, details = null) => {
							nav.navigate({name: 'MainScreen', params: {pickupLoc: {latitude: details.geometry.location.lat, longitude: details.geometry.location.lng}, pLocDesc: data.description}, merge: true});
						}
					}
					query={{
						key: API_KEY,
...
const SearchLocPickup = ({navigation}) => {

  return (
    <View style={styles.container}>
      <SearchContainer nav={navigation}/>

    </View>
  );
};

export default SearchLocPickup;
